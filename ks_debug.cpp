...
int main() {
  ...
  vector<float> d4;
  float d;
  for (int n=0;n<200;n++) {cin >> d; d1.push_back(d);}
  for (int n=0;n<300;n++) {cin >> d; d2.push_back(d);}
  for (int n=0;n<300;n++) {cin >> d; d3.push_back(d);}
  for (int n=0;n<300;n++) {cin >> d; d4.push_back(d);}
  sort(all(d1));
  sort(all(d2));
  sort(all(d3));
  sort(all(d4));
